...
export function LensDemo() {
  const cards = [
    {
      title: "AI Vision Pro",
      desc: "Next-generation AI-powered visual intelligence system for modern applications.",
      img: "https://images.unsplash.com/photo-1713869820987-519844949a8a?q=80&w=2000&auto=format&fit=crop",
    },
    {
      title: "Smart Detection",
      desc: "Real-time object and pattern recognition powered by deep learning models.",
    ...
    <section className="w-full py-24 px-6 md:px-16 bg-black text-white">
      ...
      <div className="text-center max-w-3xl mx-auto mb-14">
        ...
        <p className="mt-4 text-neutral-400 text-sm md:text-base">
          A futuristic interaction layer that enhances visual AI perception
          through dynamic lens-based intelligence.
        </p>
      </div>
...
function LensCard({ item }) {
  ...
  return (
    <div className="relative w-full max-w-md rounded-3xl overflow-hidden bg-gradient-to-br from-[#141625] to-[#0b0b10] p-6 shadow-2xl">

      {/* Glow Background */}
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-0 left-10 w-40 h-40 bg-purple-600 blur-3xl rounded-full opacity-40" />
        <div className="absolute bottom-0 right-10 w-40 h-40 bg-violet-500 blur-3xl rounded-full opacity-40" />
      </div>
