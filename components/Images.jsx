  ...
  return (
    <div className="py-20 flex flex-col lg:flex-row items-center justify-center gap-6 px-8">
      ...
      <Card title="Smart Analytics">
        ...
        {/* soft radial glow */}
        <div className="absolute inset-0 [mask-image:radial-gradient(400px_at_center,white,transparent)] bg-black/60" />
      </Card>

      <Card title="Cloud AI Engine">
        <CanvasRevealEffect
          animationSpeed={3}
    ...
    >
      ...
      <div className="relative z-10 text-center px-4">
        ...
        <p className="text-purple-300 text-sm mt-2">
          Hover to explore AI-powered visualization
        </p>
      </div>
    </div>
  );
